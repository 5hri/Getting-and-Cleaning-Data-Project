...
- The  `run_analysis.md` and `codebook.md` files are produced using knit2html()  

## Steps to produce this project

- Please see the details in `run_analysis.R` and `codebook.md`.
...
-  R script `run_analysis.r` can be used  to build the Project, but it only produces the final tidy dataset in `tidydata.txt`
